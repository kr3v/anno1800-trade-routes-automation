...
![island.png](island.png) - island screenshot from the game.

![matplotlib-example.png](matplotlib-example.png) - island's scan results visualized using matplotlib.

![island-with-scanner.png](island-with-scanner.png) - islands screenshot with scanner result on top.
